  ...
  return (
    <section className="pt-3 md:pt-6">
      <div className="container-page">
        <div className="hero-panel relative grid min-h-[310px] grid-cols-[1.3fr_.7fr] overflow-hidden rounded-[24px] bg-[#F4F0E8] sm:min-h-[390px] sm:grid-cols-[1.05fr_.95fr] md:min-h-[470px] lg:grid-cols-[1.08fr_.92fr]">
          <div className="relative z-10 flex flex-col justify-center p-3.5 sm:p-8 lg:p-12">
            <span className="mb-2 w-fit rounded-full bg-brand-gold/25 px-2.5 py-1 text-[10px] font-bold text-[#69530F] sm:mb-4 sm:px-3 sm:py-1.5 sm:text-[12px]">Bestseller</span>
            ...
            <div className="mt-3 sm:mt-6">
              <p className="text-[20px] font-extrabold text-brand sm:text-[26px]">{formatPrice(book.price)}</p>
