      ...
      <div className="container-page py-4 sm:py-9">
        ...
        <div className="mt-3 flex flex-col gap-3 sm:mt-6 sm:flex-row sm:items-end sm:justify-between sm:gap-5">
          <div>
            ...
            <h1 className="mt-1.5 text-[26px] font-extrabold leading-tight tracking-[-0.035em] text-ink sm:mt-2 sm:text-[42px]">{title}</h1>
            {description && <p className="mt-1.5 max-w-2xl text-[13px] leading-5 text-muted sm:mt-2 sm:text-base sm:leading-6">{description}</p>}
          </div>
          {aside}
        </div>
      </div>
